...
//	public void afterThrowing(JoinPoint joinPoint, ArithmeticException arithmeticException) {
//		String methodName = joinPoint.getSignature().getName();
//		System.out.println("The method " + methodName + "occurs exception: 数学参数异常 " + arithmeticException);
//	}
